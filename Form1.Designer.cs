namespace MakeBestBalance_LoL
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			// button1
			// 
			this.button1.Location = new System.Drawing.Point(877, 34);
			this.button1.Name = "button1";
			this.button1.Size = new System.Drawing.Size(172, 37);
			this.button1.TabIndex = 0;
			this.button1.Text = "선수 추가";
			this.button1.UseVisualStyleBackColor = true;
			this.button1.Click += new System.EventHandler(this.InsertNewPlayer);
			// 
			// button2
			// 
			this.button2.Location = new System.Drawing.Point(877, 78);
			this.button2.Name = "button2";
			this.button2.Size = new System.Drawing.Size(172, 41);
			this.button2.TabIndex = 1;
			this.button2.Text = "선택한 선수 삭제";
